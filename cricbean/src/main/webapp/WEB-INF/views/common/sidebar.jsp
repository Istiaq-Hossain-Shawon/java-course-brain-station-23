...
<div class="fixed-sidebar">
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
		...
		<a href="02-ProfilePage.html" class="logo">
			<div class="img-wrap">
			<%-- <img src="${pageContext.request.contextPath }/img/cricbean_logo.png" alt="Cricbean"> --%>
			</div>
		</a>
			...
			<ul class="left-menu">
				<li>
					<a href="#" class="js-sidebar-open">
						 <img style="background: currentColor;border-radius: 100%;" class="olymp-menu-icon left-menu-icon"
                                  src="${pageContext.request.contextPath }/img/menu-50.png" data-toggle="tooltip" data-placement="right" data-original-title="OPEN MENU"/>
					</a>
				</li>
				<li>
					<a href="${pageContext.request.contextPath }/country/show-all?_search=&_pageIndex=0&_rows=5&_sort=NA" data-placement="right" data-original-title="OPEN HOME">
				...
				<li>
					<a href="${pageContext.request.contextPath }/team/show-all?_search=&_pageIndex=0&_rows=5&_sort=NA" data-placement="right" data-original-title="OPEN Team">
						 <img class="olymp-star-icon left-menu-icon" src="${pageContext.request.contextPath }/img/details-40.png" />
                            <span class="left-menu-title"></span>
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				...
				<li>
					 ...
					 <a href="${pageContext.request.contextPath }/country/show-all?_search=&_pageIndex=0&_rows=5&_sort=NA"  data-toggle="tooltip" data-placement="right" data-original-title="OPEN HOME">
                            <img class="olymp-star-icon left-menu-icon" src="${pageContext.request.contextPath }/img/details-40.png" />
                            <span class="left-menu-title" >Country</span>
                        </a>
				</li>
				<li>
					
					 <a href="${pageContext.request.contextPath }/team/show-all?_search=&_pageIndex=0&_rows=5&_sort=NA"  data-toggle="tooltip" data-placement="right" data-original-title="OPEN Team">
                            <img class="olymp-star-icon left-menu-icon" src="${pageContext.request.contextPath }/img/details-40.png" />
