package com.icc.application.config.persistence;
...
@EnableJpaRepositories("com.icc.application.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.icc.application.model");
                for (Class<?> clazz : (new Reflections("com.icc.application.model")).getTypesAnnotatedWith(Entity.class)) {
